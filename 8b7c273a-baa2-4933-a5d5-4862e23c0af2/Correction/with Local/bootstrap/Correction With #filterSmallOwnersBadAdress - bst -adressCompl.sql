...
with
    inputX as (select fra, POSTORT, POSTNUMMER, ADRESS, NAMN, BETECKNING, arndenr, PERSORGNR, RowNum from
          tempdb.dbo.##filterSmallOwnersBadAdress)
   ...
   ,adressCompl as (select fra, ShooHornTable.POSTORT, ShooHornTable.POSTNUMMER, ShooHornTable.ADRESS, ShooHornTable.NAMN, BETECKNING, toComplete.arndenr, PERSORGNR, RowNum
	from toComplete left outer join	    ShooHornTable on ShooHornTable.arndenr = toComplete.arndenr)

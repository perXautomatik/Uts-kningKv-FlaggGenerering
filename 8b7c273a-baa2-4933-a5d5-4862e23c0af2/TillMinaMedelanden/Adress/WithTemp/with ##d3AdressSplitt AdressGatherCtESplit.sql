...
with
    TrimValues as (select tempdb.dbo.##d3AdressSplitt.i,C_O,ltrim(Adress2) as adress,ltrim(##d3AdressSplitt.PostOrt) as PostOrt2,##del2.POSToRT,ltrim(postnr) as postnr,POSTNUMMER,##d3AdressSplitt.adress as orgAdrr from tempdb.dbo.##d3AdressSplitt join tempdb.dbo.##del2 on tempdb.dbo.##d3AdressSplitt.i = tempdb.dbo.##del2.i),

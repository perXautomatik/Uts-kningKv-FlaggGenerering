...
begin try drop table fromBJoinInfoCurrentOwner end try begin catch end catch
...
select * into fromBJoinInfoCurrentOwner from inputJoinedByFnrInfo_current_owner

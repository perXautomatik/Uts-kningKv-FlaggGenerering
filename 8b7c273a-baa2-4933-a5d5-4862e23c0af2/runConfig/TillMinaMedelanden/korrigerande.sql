use [tempExcel]
insert into dbo.resultatRunConf  (dnr) values ('korrigerade')
...
INSERT INTO  tempdb.dbo.##fulaAttKorrigera(ÄGARE, POSTADRESS, POSTNR, POSTORT, [personnr/Organisationnr], SOURCE,id) VALUES (N'Lena Nordström', 'RUA EDUARDO HENRIQUES PEREIRA NO 1 ', 'BLOCO', '1, 2 B, 2655-267 ERICEIRA, PORTUGAL', '196204112764', 'geosecma',13), (N'Lena Katarina Nordström', '', '', 'PORTUGAL', '196204112764', 'lagfart',13)
,('Ingela Karin Spillmann', '', '', 'SCHWEIZ', '194003191246', 'lagfart',24);
END
 INSERT INTO  tempdb.dbo.##Corrigerande(Ägare, Postadress, POSTNR, POSTORT,id) VALUES
...
INSERT INTO  tempdb.dbo.##Corrigerande(ÄGARE, POSTADRESS, POSTNR, POSTORT, [personnr/Organisationnr], SOURCE,id) VALUES

select fastighet, Diarienummer, [Utskick har gått till:], till, [Lagfaren ägare], adress,
       z.strFastighetsbeteckning,z.strFastighetsbeteckning,z.strFnrID,z.recFastighetID,
    recAerendeID, intDiarienummerLoepNummer, strDiarienummer,  strDiarieSerieKod, intDiarieAar

...
with sockenVal    as (Select 'björke' "socken"
                          Union
                          Select 'dalhem' "a"
                          Union
                          Select 'fröjel' "a"
    ...
    -- create view fastighetsytor of interest
     ...
     socknarOfIntresse   as (SELECT sockenVal.socken SockenX, concat(Trakt, SPACE(1), Blockenhet) FAStighet, Shape from sde_gsd.gng.AY_0980 x

...
CREATE FUNCTION sp_xFirMinimized(@DIAKIR AS HANDELSETABLETYPE READONLY)
	...
	WITH
	    FIRRAW AS
		(SELECT PERSORGNR, FAL_CO, FAL_UTADR1, FAL_UTADR2, FAL_POSTNR, FAL_POSTORT, SAL_CO, SAL_UTADR1, SAL_UTADR2, SAL_POSTNR, SAL_POSTORT, UA_UTADR1, UA_UTADR2, UA_UTADR3, UA_UTADR4, UA_LAND--,input.fastighet

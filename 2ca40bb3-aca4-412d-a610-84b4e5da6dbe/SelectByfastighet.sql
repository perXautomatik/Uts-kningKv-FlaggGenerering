-- due to the clr type, shape column, we can't use synonyms of this remote tables, we need a pass-through query; execute etc

/*;if object_id('tempExcel.dbo.ENSKILT_AVLOPP_NORRA_P') 	is null begin CREATE SYNONYM ENSKILT_AVLOPP_NORRA_P for  [gisdb01].sde_miljo_halsoskydd.gng.ENSKILT_AVLOPP_NORRA_P 	END;
;if object_id('tempExcel.dbo.ENSKILT_AVLOPP_mellersta_P') 	is null begin CREATE SYNONYM ENSKILT_AVLOPP_mellersta_P for  [gisdb01].sde_miljo_halsoskydd.gng.ENSKILT_AVLOPP_mellersta_P 	END;
;if object_id('tempExcel.dbo.ENSKILT_AVLOPP_SODRA_P') 	is null begin CREATE SYNONYM ENSKILT_AVLOPP_SODRA_P for  [gisdb01].sde_miljo_halsoskydd.gng.ENSKILT_AVLOPP_SODRA_P 	END;

;if object_id('tempExcel.dbo.rening_NORRA_P') 	is null begin CREATE SYNONYM rening_NORRA_P for  [gisdb01].sde_miljo_halsoskydd.gng.rening_NORRA_P 	END;
;if object_id('tempExcel.dbo.rening_mellersta_P') 	is null begin CREATE SYNONYM rening_mellersta_P for  [gisdb01].sde_miljo_halsoskydd.gng.rening_mellersta_P 	END;
;if object_id('tempExcel.dbo.rening_SODRA_P') 	is null begin CREATE SYNONYM rening_SODRA_P for  [gisdb01].sde_miljo_halsoskydd.gng.rening_SODRA_P 	END;
*/
--select * from rening_norra_p

    --handles even incomplete searchterms as long as socken is complete
declare @searchstring nvarchar(50); set @searchstring = N'FÅRÖ STORA GASMORA 1:57'
...
with enskiltUnion as (
    select OBJECTID, Diarienummer, Fastighet_tillstand, Typ_byggnad, Antal_hushall_tillstand, Fastighet_rening, Typ_slamavskiljare, Storlek_m3, Typ_rening, Storlek_m2, Typ_sluten_tank, Storlek_m, Beslut_datum, Utford_datum, Avgift, Tillstand_giltigt_tom, Anteckning
	    from ENSKILT_AVLOPP_NORRA_P union
    select OBJECTID, Diarienummer, Fastighet_tilstand, Typ_byggnad, Antal_hushall_tillstand, Fastighet_rening, Typ_slamavskiljare, Storlek_m3, Typ_rening, Storlek_m2, Typ_sluten_tank, Storlek_m, Beslut_datum, Utford_datum, Avgift, Tillstand_giltigt_tom, Anteckning
    	    from ENSKILT_AVLOPP_mellersta_P union
    select OBJECTID, Diarienummer, Fastighet_tillstand, Typ_byggnad, Antal_hushall_tillstand, Fastighet_rening, Typ_slamavskiljare, Storlek_m3, Typ_rening, Storlek_m2, Typ_sluten_tank, Storlek_m, Beslut_datum, Utford_datum, Avgift, Tillstand_giltigt_tom, Anteckning
    	    from ENSKILT_AVLOPP_SODRA_P)
...
,    reningarUNion      as (
	select OBJECTID, Fastighet_rening, Antal_hushall_rening, reningstyp, Storlek_m2, Beslut_datum, Utford_datum, Kommentarer, Anslutna_fastigheter_1, Anslutna_fastigheter_2, Anslutna_fastigheter_3, Anslutna_fastigheter_4, Anslutna_fastigheter_5, Anslutna_fastigheter_6, Anslutna_fastigheter_7, Anslutna_fastigheter_8, Anslutna_fastigheter_9, Anslutna_fastigheter_10
		from RENING_MELLERSTA_P union
	select OBJECTID, Fastighet_rening, Antal_hushall_rening, reningstyp, Storlek_m2, Beslut_datum, Utford_datum, Kommentarer, Anslutna_fastigheter_1, Anslutna_fastigheter_2, Anslutna_fastigheter_3, Anslutna_fastigheter_4, Anslutna_fastigheter_5, Anslutna_fastigheter_6, Anslutna_fastigheter_7, Anslutna_fastigheter_8, Anslutna_fastigheter_9, Anslutna_fastigheter_10
		from RENING_NORRA_P union
	select OBJECTID, Fastighet_rening, Antal_hushall_rening, reningstyp, Storlek_m2, Beslut_datum, Utford_datum, Kommentarer, Anslutna_fastigheter_1, Anslutna_fastigheter_2, Anslutna_fastigheter_3, Anslutna_fastigheter_4, Anslutna_fastigheter_5, Anslutna_fastigheter_6, Anslutna_fastigheter_7, Anslutna_fastigheter_8, Anslutna_fastigheter_9, Anslutna_fastigheter_10
		from RENING_SODRA_P)
